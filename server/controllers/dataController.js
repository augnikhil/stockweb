...
exports.getStockMetaData = async (req, res) => {
  try {
    const url = `https://api.tiingo.com/tiingo/daily/${req.params.ticker}?token=${"400478aed5bb27c3a4cfe54324ec7af878f80417"}`;
...
exports.getStockHistoricData = async (req, res) => {
  try {
    ...
    const url = `https://api.tiingo.com/tiingo/daily/${req.params.ticker}/prices?startDate=${year}-${month}-${day}&token=${"400478aed5bb27c3a4cfe54324ec7af878f80417"}`;
...
exports.getRandomStockData = async (req, res) => {
  try {
    ...
    const url = `https://api.tiingo.com/tiingo/daily/${stock.ticker}/prices?startDate=${year}-${month}-${day}&token=${"400478aed5bb27c3a4cfe54324ec7af878f80417"}`;
